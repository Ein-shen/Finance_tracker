...
import { Calendar, BarChart2, User, Receipt, Settings, LogOut } from 'lucide-react'
...
export const Leftsidebar = () => {
  ...
  return (
    <div
      className="h-screen w-64 border-r-2 fixed left-0 flex flex-col items-center text-center"
      ...
      <div className="w-full space-y-4 px-6">
        {navItems.map(({ label, icon: Icon, path }) => (
          <button
            ...
            className="w-full flex items-center gap-2 font-mono text-md rounded-md p-2 hover:bg-gray-100 hover:text-black"
